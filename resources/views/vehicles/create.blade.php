...
<form action="{{ route('vehicles.store') }}" method="POST">
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 cold-md-12">
            <div class="form-group">
                <strong>Tahun:</strong>
                <input type="text" pattern="[0-9]+" name="tahun" class="form-control" placeholder="Tahun">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 cold-md-12">
            <div class="form-group">
                <strong>Jumlah Penumpang:</strong>
                <input type="text" pattern="[0-9]+" name="jumlah_penumpang" class="form-control" placeholder="Tahun">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 cold-md-12">
            <div class="form-group">
                <strong>Manufaktur:</strong>
                <input type="text" name="manufaktur" class="form-control" placeholder="Manufaktur">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 cold-md-12">
            <div class="form-group">
                <strong>Harga:</strong>
                <input type="text" pattern="[0-9]+" name="harga" class="form-control" placeholder="Harga">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 cold-md-12">
            <div class="form-group">
        ...
        <div id="mobilAttributes" style="display:none;">
            <div class="col-xs-12 col-sm-12 cold-md-12">
                ...
                <div class="form-group">
                    ...
                    <input type="text" pattern="[0-9]+" name="luas_bagasi" class="form-control" placeholder="Luas Bagasi">
                </div>
            </div>
        </div>
        <div id="motorAttributes" style="display:none;">
            <div class="col-xs-12 col-sm-12 cold-md-12">
                <div class="form-group">
                    ...
                    <input type="text" pattern="[0-9]+" name="ukuran_bagasi" class="form-control" placeholder="Ukuran Bagasi">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 cold-md-12">
                <div class="form-group">
                    <strong>Kapasitas Bensin:</strong>
                    <input type="text" pattern="[0-9]+" name="kapasitas_bensin" class="form-control" placeholder="Kapasitas Bensin">
                </div>
            </div>
        </div>
        <div id="trukAttributes" style="display:none;">
            <div class="col-xs-12 col-sm-12 cold-md-12">
                <div class="form-group">
                    ...
                    <input type="text" pattern="[0-9]+" name="roda_ban" class="form-control" placeholder="Roda Ban">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 cold-md-12">
                <div class="form-group">
                    <strong>Luas Area Kargo:</strong>
                    <input type="text" pattern="[0-9]+" name="luas_area_kargo" class="form-control" placeholder="Luas Area Kargo">
                </div>
            </div>
        </div>
...
<script>
    $(document).ready(function(){
        ...
        showAdditionalAttributes($('#jenis').val());
